...
func Store(w http.ResponseWriter, r *http.Request) {
	...
	_, err := note.Create(c.DB, r.FormValue("firstname"), r.FormValue("middlename"), r.FormValue("lastname"), r.FormValue("manager"), r.FormValue("personalemail"), r.FormValue("businessemail"), r.FormValue("homephone"), r.FormValue("mobilephone"), r.FormValue("workphone"), r.FormValue("addressline1"), r.FormValue("housenamenumber"), r.FormValue("addressline2"), r.FormValue("apartmentsuite"), r.FormValue("town"), r.FormValue("county"), r.FormValue("postcode"), r.FormValue("country"), r.FormValue("noktitle"), r.FormValue("nokfirstname"), r.FormValue("noklastname"), r.FormValue("nokrelationship"), r.FormValue("nokaddressline1"),	r.FormValue("nokhousenamenumber"), 	r.FormValue("nokaddressline2"),	r.FormValue("nokapartmentsuite"),	r.FormValue("noktown"),	r.FormValue("nokcounty"),	r.FormValue("nokpostcode"), r.FormValue("nokcountry"),r.FormValue("nokhomephone"), r.FormValue("nokworkphone"), r.FormValue("ec1title"), r.FormValue("ec1firstname"), r.FormValue("ec1lastname"), r.FormValue("ec1relationship"), r.FormValue("ec1addressline1"), r.FormValue("ec1housenamenumber"), r.FormValue("ec1addressline2"), r.FormValue("ec1apartmentsuite"), r.FormValue("ec1town"), r.FormValue("ec1county"), r.FormValue("ec1postcode"), r.FormValue("ec1country"),  r.FormValue("ec1homephone"),  r.FormValue("ec1workphone"), r.FormValue("ec2title"), r.FormValue("ec2firstname"), r.FormValue("ec2lastname"), r.FormValue("ec2relationship"), r.FormValue("ec2addressline1"), r.FormValue("ec2housenamenumber"), r.FormValue("ec2addressline2"), r.FormValue("ec2apartmentsuite"), r.FormValue("ec2town"), r.FormValue("ec2county"), r.FormValue("ec2postcode"), r.FormValue("ec2country"), r.FormValue("ec2homephone"),  r.FormValue("ec2workphone"),r.FormValue("ec3title"), r.FormValue("ec3firstname"), r.FormValue("ec3lastname"), r.FormValue("ec3relationship"), r.FormValue("ec3addressline1"), r.FormValue("ec3housenamenumber"), r.FormValue("ec3addressline2"), r.FormValue("ec3apartmentsuite"), r.FormValue("ec3town"), r.FormValue("ec3county"), r.FormValue("ec3postcode"), r.FormValue("ec3country"),r.FormValue("ec3homephone"),  r.FormValue("ec3workphone"), r.FormValue("futureuse1"), r.FormValue("futureuse2"), r.FormValue("futureuse3"), r.FormValue("futureuse4"), c.UserID)
	if err != nil {
		c.FlashErrorGeneric(err)
		Create(w, r)
		return
...
func Update(w http.ResponseWriter, r *http.Request) {
	...
	_, err := note.Update(c.DB, r.FormValue("firstname"), r.FormValue("middlename"), r.FormValue("lastname"), r.FormValue("manager"), r.FormValue("personalemail"), r.FormValue("businessemail"), r.FormValue("homephone"), r.FormValue("mobilephone"), r.FormValue("workphone"), r.FormValue("addressline1"), r.FormValue("housenamenumber"), r.FormValue("addressline2"), r.FormValue("apartmentsuite"), r.FormValue("town"), r.FormValue("county"), r.FormValue("postcode"), r.FormValue("country"), r.FormValue("noktitle"), r.FormValue("nokfirstname"), r.FormValue("noklastname"), r.FormValue("nokrelationship"), r.FormValue("nokaddressline1"),	r.FormValue("nokhousenamenumber"), 	r.FormValue("nokaddressline2"),	r.FormValue("nokapartmentsuite"),	r.FormValue("noktown"),	r.FormValue("nokcounty"),	r.FormValue("nokpostcode"), r.FormValue("nokcountry"),r.FormValue("nokhomephone"), r.FormValue("nokworkphone"), r.FormValue("ec1title"), r.FormValue("ec1firstname"), r.FormValue("ec1lastname"), r.FormValue("ec1relationship"), r.FormValue("ec1addressline1"), r.FormValue("ec1housenamenumber"), r.FormValue("ec1addressline2"), r.FormValue("ec1apartmentsuite"), r.FormValue("ec1town"), r.FormValue("ec1county"), r.FormValue("ec1postcode"), r.FormValue("ec1country"), r.FormValue("ec1homephone"),  r.FormValue("ec1workphone"), r.FormValue("ec2title"), r.FormValue("ec2firstname"), r.FormValue("ec2lastname"), r.FormValue("ec2relationship"), r.FormValue("ec2addressline1"), r.FormValue("ec2housenamenumber"), r.FormValue("ec2addressline2"), r.FormValue("ec2apartmentsuite"), r.FormValue("ec2town"), r.FormValue("ec2county"), r.FormValue("ec2postcode"), r.FormValue("ec2country"), r.FormValue("ec2homephone"),  r.FormValue("ec2workphone"),r.FormValue("ec3title"), r.FormValue("ec3firstname"), r.FormValue("ec3lastname"), r.FormValue("ec3relationship"), r.FormValue("ec3addressline1"), r.FormValue("ec3housenamenumber"), r.FormValue("ec3addressline2"), r.FormValue("ec3apartmentsuite"), r.FormValue("ec3town"), r.FormValue("ec3county"), r.FormValue("ec3postcode"), r.FormValue("ec3country"), r.FormValue("ec3homephone"),  r.FormValue("ec3workphone"),r.FormValue("futureuse1"), r.FormValue("futureuse2"), r.FormValue("futureuse3"), r.FormValue("futureuse4"), c.Param("id"), c.UserID)
	if err != nil {
		c.FlashErrorGeneric(err)
		Edit(w, r)
		return
